...
class TypeBuilder(type_builder.TypeBuilder):
    def __init__(self):
        super().__init__(classes=set(
          ["Chapter","Characters","Relationship",]
        ), enums=set(
          ["Weight",]
    ...
    @property
    def Chapter(self) -> "ChapterViewer":
        return ChapterViewer(self)
...
class ChapterAst:
    def __init__(self, tb: type_builder.TypeBuilder):
        _tb = tb._tb # type: ignore (we know how to use this private attribute)
        self._bldr = _tb.class_("Chapter")
        self._properties: typing.Set[str] = set([  "title",  "number",  "start_boundary_text",  "end_boundary_text",  "characters",  ])
        self._props = ChapterProperties(self._bldr, self._properties)

    def type(self) -> baml_py.FieldType:
        return self._bldr.field()

    @property
    def props(self) -> "ChapterProperties":
        return self._props


class ChapterViewer(ChapterAst):
    def __init__(self, tb: type_builder.TypeBuilder):
        super().__init__(tb)
...
class ChapterProperties:
    ...
    @property
    def start_boundary_text(self) -> type_builder.ClassPropertyViewer:
        return type_builder.ClassPropertyViewer(self.__bldr.property("start_boundary_text"))
    
    @property
    def end_boundary_text(self) -> type_builder.ClassPropertyViewer:
        return type_builder.ClassPropertyViewer(self.__bldr.property("end_boundary_text"))
